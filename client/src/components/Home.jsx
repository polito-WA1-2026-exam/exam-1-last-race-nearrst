                        ...
                        <Col md={6}>
                            <div className="d-flex gap-3">
                                <div>
                                    ...
                                    <div style={{ color: '#95a5a6', fontSize: 13 }}>
                                        You're assigned a start and a destination. Build your route
                        ...
                        <Col md={6}>
                            <div className="d-flex gap-3">
                                <div>
                                    ...
                                    <div style={{ color: '#95a5a6', fontSize: 13 }}>
                                        Your route is validated. Each segment brings a random event which results in 
            ...
            <Card bg="dark" border="secondary" className="mb-3">
                <Card.Body className="p-4">
                    ...
                    <div style={{ fontSize: 13, color: '#95a5a6' }}>
                        ...
                        Each segment you travel triggers a random event.
                        Event effects range from -4 to{' '} +4 coins.
